...
import com.orot.ody.BuildConfig
...
object PangleHelper {
    ...
    const val pangleAppId: String = "8147292"
    ...
    fun initialize(context: Context) {
        val pageConfig = PAGConfig.Builder()
            ...
            .debugLog(BuildConfig.DEBUG) // 디버그 모드 설정
            .build()
    ...
    fun loadInterstitialAd(
        placementId: String,
        interstitialRequest: PAGInterstitialRequest,
        advertiseListener: AdvertiseListener<PAGInterstitialAd?>?
    ) {
        PAGInterstitialAd.loadAd(placementId, interstitialRequest, object : PAGInterstitialAdLoadListener {
            override fun onError(p0: Int, p1: String?) {
                /**
                 * 이 메서드는 광고 로드에 실패할 때 호출됩니다.
                 * 여기에는 발생한 오류 유형을 나타내는 Error 유형의 오류 매개변수가 포함됩니다.
