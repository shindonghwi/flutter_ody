...
class PatchMeWeightUseCase {
  PatchMeWeightUseCase();

  final RemoteMeRepository _remoteMeRepository = GetIt.instance<RemoteMeRepository>();

  Future<ApiResponse<void>> call({required int weight}) async {
    return await _remoteMeRepository.patchWeight(weight);
  }
}
