  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(
          getAppLocalizations(context).bottom_sheet_bp_table_title,
        ...
        Text(
          getAppLocalizations(context).bottom_sheet_bp_table_description,
        ...
        Container(
          ...
          child: Image.asset(
            'assets/imgs/image_bp_table.png',
            width: 340,
          ),
        ),
        const SizedBox(
        ...
        Text(
          getAppLocalizations(context).bottom_sheet_bp_table_origin_info,
          style: getTextTheme(context).c2r.copyWith(
                color: getColorScheme(context).neutral80,
              ),
        ),
