...
class ReportWeeklyListScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final uiState = ref.watch(reportWeeklyListProvider);
    final uiStateRead = ref.read(reportWeeklyListProvider.notifier);
    ...
    return Scaffold(
      appBar: IconTitleIconAppBar(
        ...
        title: getAppLocalizations(context).list_report_weekly_title,
      ),
        ...
        children: [
          if (uiState is Success<List<ResponseBioReportListModel>>)
            !CollectionUtil.isNullorEmpty(uiState.value)
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        FittedBox(
                                          ...
                                          child: Text(
                                            getAppLocalizations(context).list_report_weekly_title,
                                    ...
                                    FittedBox(
                                      fit: BoxFit.scaleDown,
                                      child: Text(
                                        "${item.year}년 ${item.minDate.split("-")[1]}.${item.minDate.split("-")[2]} - ${item.maxDate.split("-")[1]}.${item.maxDate.split("-")[2]}",
                ...
                : Center(
                    child: EmptyView(
                      screen: RoutingScreen.ReportWeeklyList,
                      onPressed: () => Navigator.of(context).pop(),
                    ),
                  ),
