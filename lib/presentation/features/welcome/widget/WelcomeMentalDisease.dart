...
import 'package:odac_flutter_app/presentation/features/welcome/widget/provider/disease/SelectorMentalDiseaseProvider.dart';
...
class WelcomeMentalDisease extends StatelessWidget {
  WelcomeMentalDisease({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (_) => SelectorMentalDiseaseProvider(context)),
      ],
      child: Scaffold(
        ...
        return Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext ctx, int idx) {
              return _DiseaseItem(
                  diseaseName: _selectorMentalDiseaseProvider.diseaseList[idx].diseaseName);
            },
          ),
        );
      },
